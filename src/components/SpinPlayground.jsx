...
const SpinPlayground = () => {
  return (
    <div className='pt-24 mx-20'>
        <p className=' text-7xl space-grotesk text-center font-medium bg-gradient-to-b from-customStart to-customEnd bg-clip-text text-transparent'>SPIN PLAYGROUND</p>

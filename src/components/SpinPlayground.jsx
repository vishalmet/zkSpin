...
const SpinPlayground = () => {
  return (
    <div className=' pt-8 md:pt-16 lg:pt-24 mx-4 md:mx-20'>
        <p className=' text-4xl md:text-5xl lg:text-7xl space-grotesk text-center font-medium bg-gradient-to-b from-customStart to-customEnd bg-clip-text text-transparent'>SPIN PLAYGROUND</p>
